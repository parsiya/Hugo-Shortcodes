...
```
{{< xref title="named-title" path="/post/2021/2021-04-30-testing-extensions-edge/" anchor="brief-recon" >}}
```
...
The first one is more readable in markdown source.
